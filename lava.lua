...
if contentH<=32 then
task.defer(function()
local pg2=tabPages[key]; if not pg2 then return end
local pll2=pg2:FindFirstChildOfClass("UIListLayout"); if not pll2 then return end
local h2=pll2.AbsoluteContentSize.Y+32
pg2.Size=UDim2.new(1,0,0,h2)
maxScrolls[key]=math.max(0,h2-CLIP_H)
if key=="Player" and activeTab=="Player" and not playerTabWarningActive then updateScrollbar() end
end)
return
end
